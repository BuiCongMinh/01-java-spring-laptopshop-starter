                                ...
                                <tbody>
                                    <c:forEach var="cart" items="${listCart}">
                                        <tr>
                                            ...
                                            <td>
                                                <p class="mb-0 mt-4">
                                                    <fmt:formatNumber type="number" value="${cart.price}" /> vnđ
                                                </p>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <p class="mb-0 mt-4">
                                                    <fmt:formatNumber type="number"
                                                        value="${cart.quantity * cart.product.price}" /> vnđ
                                                </p>
                                            </td>
                                            <td>
                            ...
                            <div class="col-12 col-md-8">
                                <div class="bg-light rounded">
                                    <div class="p-4">
                                        ...
                                        <p class="mt-4 text-center">Shipping to Ukraine :))))))</p>
                                    </div>
                                    <div class="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
                                        <h5 class="mb-0 ps-4 me-4">Tổng Tất Cả: </h5>
                                        <p class="mb-0 pe-4">
                                            <fmt:formatNumber type="number" value="${totalPrice}" /> vnđ
                                        </p>
                                    </div>
